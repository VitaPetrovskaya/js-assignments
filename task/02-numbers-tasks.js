...
{
    let a = Math.pow(((x1 - 0)*(x1 - 0) + (y1 - 0)*(y1 - 0)), 0.5);
    let b = Math.pow(((x2 - 0)*(x2 - 0) + (y2 - 0)*(y2 - 0)), 0.5);
    let c = Math.pow(((x2 - x1)*(x2 - x1) + (y2 - y1)*(y2 - y1)), 0.5);
    let expr = Math.acos((x1*x1+y1*y1 + x2*x2+y2*y2 - ((x2 - x1)*(x2 - x1) + (y2 - y1)*(y2 - y1)))/(2*a*b));
    return expr;
}
