...
{
    let alfphabet1 = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
    let alfphabet2 = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
    let str_new = '';
    let num = 0;

    for (var i = 0; i < str.length; i++) 
    {
        num = alfphabet1.indexOf(str[i]);
        if (num == -1)
        {
           str_new += str[i];
        }
